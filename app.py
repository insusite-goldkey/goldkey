        ...
        with col1:
            ...
            if do_d:
                ...
                run_ai_analysis(c_name_d, query_d, hi_d, "res_disability",
                    ...
                    "- 비급여 수술비 실손 청구 가능 범위\n\n"
                    "### 4. 간병인사용 보험금 산출\n"
                    "- 간병인사용일당 지급 요건 (입원 중 간병인 사용 확인서 필요)\n"
                    "- 3개월 입원 기간 간병인 사용 시 총 지급 예상액\n"
                    "- 간병인사용 인정 기준 (보험사별 차이: 중환자실·일반병실 구분)\n"
                    "- 간병인 영수증 없이도 청구 가능한 경우 설명\n\n"
                    "### 5. 전체 청구 가능 보험금 합산표\n"
        ...
        with col1:
            ...
            if do4:
                ...
                run_ai_analysis(c_name4, query4, hi4, "res_t4",
                    ...
                    "- 경찰 교통사고 사실확인원 발급 절차\n\n"
                    "### 5. 가해자 유족 관련 법적 리스크 대응\n"
                    "- 신호위반 가해자 유족이 '공동불법행위' 주장 시 반박 논리\n"
                    "- 과실 0% 입증을 위한 증거 수집 체크리스트\n"
