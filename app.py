  ...
  font-weight:900;font-size:0.9rem;color:#0d3b2e;">🤖 AI 분석 리포트</div>""",
            ...
            if ps_do:
                if 'user_id' not in st.session_state:
                    ...
                    # ── 운전자보험 전용 분석 기준 프롬프트 ──────────────────────────────
                    # 운전자보험은 교통사고 가해자 발생 시 형사·법률비용 보전이 제1목적.
                    # 11중과실(음주·약물·무면허·뺑소니 4개 제외) 및 중상해사고 대비가 핵심.
                    _PS_DRIVER_PROMPT = (
                        "\n\n[운전자보험 전용 분석 기준 — 운전하는 피보험자 필수 적용]\n"
                        "운전자보험 제1목적: 교통사고 가해자 발생 시 형사·법률비용 보전.\n"
                        "11중과실(음주·약물·무면허·뺑소니 4개 제외) 및 중상해사고 시 핵심담보 우선 분석.\n\n"

                        "## 핵심 6개 담보 (가장 먼저 검토 — 없으면 즉시 보완 권고)\n"
                        "1. 교통사고처리지원금\n"
                        "   - 적정기준: 2억원 이상 / 경찰서 불기소 단계부터 보장 여부 반드시 확인\n"
                        "   - 2억 미만이면 중상해사고 합의금·형사비용 보전에 크게 부족함\n"
                        "2. 형사합의금 (6주미만 상해)\n"
                        "   - 6주미만 경상 피해자에 대한 형사합의금 보장 포함 여부 확인\n"
                        "   - 미포함 시 경미 사고에서도 형사합의 부담 발생\n"
                        "3. 대인벌금 / 대물벌금\n"
                        "   - 대인벌금 적정기준: 3,000만원 / 대물벌금 적정기준: 500만원\n"
                        "   - 가입금액 미달 시 실제 벌금액과 보상액 차이 발생\n"
                        "4. 변호사선임비용\n"
                        "   - 경찰서 기소단계 이전(수사단계)부터 보장 여부 확인 — 수사 단계부터 보장 상품이 유리\n"
                        "   - 미가입 또는 수사단계 미보장 시 형사 대응비용 전액 자부담\n"
                        "5. 상해후유장해 (3%~10% 구간)\n"
                        "   - 적정기준: 최소 1억원 / 5억원이 이상적\n"
                        "   - 보험사 1인당 가입한도 대부분 1억 → 5억 설계 시 복수 가입 필요\n"
                        "   - 10% 장해 발생 시 재활까지 최소 18개월 이상 소요 → 생활비 보전 범위 확인 필수\n"
                        "   ※ 대안: 자동차사고부상위로금(14급 보상) 포함 여부도 병행 확인\n"

                        "\n## 보완 5개 담보 (핵심 6개 확보 후 추가 검토)\n"
                        "1. 골절 관련 담보\n"
                        "   - 골절진단비 / 골절수술비 / 5대골절진단비 / 5대골절수술비\n"
                        "   - 정면충돌 시 경골·비골·슬개골·대퇴골두·손목뼈·경추뼈 골절 다발 → 상해담보 충분 확보 필요\n"
                        "   - 50세 이상 골다공증 환자: 요추 압박골절 다발 위험 높음 → 골절담보 더욱 중요\n"
                        "2. 상해수술비\n"
                        "   - 교통사고 부상 시 수술비 보전 / 중상해 시 복수 수술 가능성 고려\n"
                        "3. 상해후유장해 (20%·50%·80% 구간)\n"
                        "   - 일반상해 / 교통상해 각각 가입금액 확인 / 치명적상해후유장해 포함 여부 확인\n"
                        "4. 상해입원일당 / 중상해입원일당\n"
                        "   - 중상해 시 장기입원(18개월↑) 생활비 보전 목적\n"
                        "   - 중상해입원일당은 일반 상해입원일당보다 지급 기준 넓음 — 별도 확인\n"
                        "5. 민사소송법률비용\n"
                        "   - 형사 외 민사 피소 시 소송 대응비용 보전\n"

                        "\n## 상해후유장해 집중 분석 관점\n"
                        "- 3%이상 후유장해: 보험사 1인당 가입한도 대부분 1억 → 5억 이상 설계가 적정\n"
                        "- 10% 장해 발생 시 재활까지 최소 18개월 이상 소요 → 해당 기간 생활비 보전 범위 확인\n"
                        "- 각종 부대담보(골절·수술·입원일당)는 중상해 시 부족한 생활비 보전 대용으로 활용\n"
                        "- 정면충돌 사고: 경골·비골·슬개골·대퇴골두·손목뼈·경추뼈 골절 다발 → 상해담보 충분 확보\n"

                        "\n## 분석 출력 지시 (운전자보험 전용 — 아래 형식 엄수)\n\n"
                        "### 1. 운전자보험 담보 현황표 (10행 이내 — 핵심·보완 담보만)\n"
                        "아래 표 형식으로 출력. 증권에 없는 담보는 '미가입'으로 표기.\n"
                        "| 구분 | 담보명 | 가입금액 | 적정기준 | 평가 |\n"
                        "|------|--------|----------|----------|------|\n"
                        "핵심①~⑥, 보완①~⑤ 순서로 작성. 표 행수는 최대 11행.\n"
                        "평가 셀: 충족 ✅ / 미달 ⚠️ / 미가입 ❌ 중 하나만 사용.\n\n"
                        "### 2. 보장 공백 진단 (3줄 이내)\n"
                        "❌·⚠️ 항목만 긴급도 순으로 나열. 각 1줄 이내.\n\n"
                        "### 3. 신규 설계 제안 (3가지, 각 1줄)\n"
                        "공백 해소 우선순위 3가지와 이유 한 줄씩.\n\n"
                        "### 4. 현장 설득 화법 (2가지, 각 1줄)\n"
                        "형사비용·합의금 실사례 기반 화법 2가지.\n"
                    )

                    # 운전자보험 선택 여부에 따라 전용 분석 기준 적용
                    _is_driver_ins = "운전자보험" in ps_product
                    _ps_product_section = _PS_DRIVER_PROMPT if _is_driver_ins else (
                        "\n## 필수 분석 항목 (아래 순서대로)\n\n"
                        "### 1. 담보 구조 분석\n"
