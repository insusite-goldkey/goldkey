...
# ==========================================
# [SECTION 1] 기본 설정 및 보안 엔진 (복구 완료)
# ==========================================
st.set_page_config(page_title="골드키지사 AI 마스터", page_icon="👑", layout="wide")

# [🚨 핵심 보안 로직 복구] API 키 설정 확인 및 예외 처리
try:
...
with st.sidebar:
    ...
    st.markdown('<a href="https://aistudio.google.com/app/apikey" target="_blank" style="text-decoration: none;"><button style="width: 100%; border-radius: 5px; background-color: #1E88E5; color: white; border: none; padding: 10px; cursor: pointer;">🌐 구글 API 키 발급 (새 창 열기)</button></a>', unsafe_allow_html=True)
...
# ==========================================
# [SECTION 7] 전문가 그룹 통합 분석 (시스템 최적화)
# ==========================================
st.divider()
